...
parser.add_argument("temp_dir",type=pathlib.Path,help="The temporary output directory for intermediate results")
...
parser.add_argument("-od","--outdir",default=None,help="The output directory for downsample results")
